...
RegisterServerEvent('esx_tequilala:getFridgeStockItem')
AddEventHandler('esx_tequilala:getFridgeStockItem', function(itemName, count)
...
ESX.RegisterServerCallback('esx_tequilala:getFridgeStockItems', function(source, cb)
...
RegisterServerEvent('esx_tequilala:putFridgeStockItems')
AddEventHandler('esx_tequilala:putFridgeStockItems', function(itemName, count)
...
RegisterServerEvent('esx_tequilala:buyItem')
AddEventHandler('esx_tequilala:buyItem', function(itemName, price, itemLabel)
...
RegisterServerEvent('esx_tequilala:craftingCoktails')
AddEventHandler('esx_tequilala:craftingCoktails', function(itemValue)
...
ESX.RegisterServerCallback('esx_tequilala:getVaultWeapons', function(source, cb)
...
ESX.RegisterServerCallback('esx_tequilala:addVaultWeapon', function(source, cb, weaponName)
...
ESX.RegisterServerCallback('esx_tequilala:removeVaultWeapon', function(source, cb, weaponName)
