...
AddEventHandler('securityvans:recievemoney', function(payOut)
	...
	TriggerClientEvent('esx:showNotification', source, 'Has recibido ' .. payOut)
...
AddEventHandler('securityvans:recieveitem', function()
	...
	TriggerClientEvent('esx:showNotification', source, "Sacaste una gran bolsa de dinero de la parte trasera.")
...
AddEventHandler('securityvans:sellbigmoneybag', function()
	...
	if playerItemCount > 0 then
		...
		xPlayer.addAccountMoney('black_money', payOut)
		TriggerClientEvent('esx:showNotification', source, "Vendiste una gran bolsa de dinero.")
	else
		TriggerClientEvent('esx:showNotification', source, "No tiene una gran bolsa de dinero en usted")
	end
end)
