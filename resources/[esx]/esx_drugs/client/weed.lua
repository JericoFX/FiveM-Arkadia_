...
Citizen.CreateThread(function()
	while true do
		...
		if GetDistanceBetweenCoords(coords, Config.CircleZones2.WeedField.coords, true) < 50 then
			SpawnWeedPlants()
			Citizen.Wait(500)
		else
			Citizen.Wait(500)
...
function ValidateWeedCoord(plantCoord)
	if spawnedWeeds > 0 then
		...
		if GetDistanceBetweenCoords(plantCoord, Config.CircleZones2.WeedField.coords, false) > 50 then
			validate = false
		end
...
function GenerateWeedCoords()
	while true do
		...
		weedCoordX = Config.CircleZones2.WeedField.coords.x + modX
		weedCoordY = Config.CircleZones2.WeedField.coords.y + modY
