...
function BildirimGonder()
	ESX.TriggerServerCallback('esx_drugs:isCooldown', function(cooldown)
		if cooldown <= 0 then
        ...
        crossing = GetStreetNameFromHashKey(crossing)
            ...
            TriggerServerEvent('esx_phone:send', "police", "Birileri Kenevir Satıyor."
             , true, {
                x = coords.x,
                y = coords.y,
                z = coords.z
