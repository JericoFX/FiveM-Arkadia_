		...
		if IsPedSittingInAnyVehicle(GetPlayerPed(-1)) then 
			for i = 1, #CivRepairStation do
				...
				if GetDistanceBetweenCoords(GetEntityCoords(GetPlayerPed(-1)), garageCoords2[1], garageCoords2[2], garageCoords2[3], true ) < 5 then
				 ESX.ShowHelpNotification('Presione ~INPUT_CONTEXT~ para la reparación rápida de vehículos')
...
if insidemarkercheck == true and stage1 == true and stage2 == false and stage3 == false and stage4 == false and stage5 == false and stage6 == false then
 Draw3DText(1153.9860839844, -781.12658691406, 57.598682403564 + 0.2, tostring("~w~Estamos revisando su vehiculo ~o~Vuelve mas tarde"))
  Draw3DText2(1153.9860839844, -781.12658691406, 57.598682403564, tostring("~w~Estado de reparación: ~r~25%"))
    Draw3DText2(1153.9860839844, -781.12658691406, 57.598682403564 - 0.2, tostring("~w~Comprobando su vehículo..."))
end
...
if insidemarkercheck == true and stage1 == false and stage2 == true and stage3 == false and stage4 == false and stage5 == false and stage6 == false then
 Draw3DText(1153.9860839844, -781.12658691406, 57.598682403564 + 0.2, tostring("~w~Todavia estamos revisando su vehiculo ~o~Vuelve mas tarde"))
 Draw3DText2(1153.9860839844, -781.12658691406, 57.598682403564, tostring("~w~Estado de reparación: ~o~45%"))
 Draw3DText2(1153.9860839844, -781.12658691406, 57.598682403564 - 0.2, tostring("~w~Trabajando en el motor..."))
end 
...
if insidemarkercheck == true and stage1 == false and stage2 == false and stage3 == true and stage4 == false and stage5 == false and stage6 == false then
 Draw3DText(1153.9860839844, -781.12658691406, 57.598682403564 + 0.2, tostring("~w~Todavia estamos revisando su vehiculo ~o~Vuelve mas tarde"))
 Draw3DText2(1153.9860839844, -781.12658691406, 57.598682403564, tostring("~w~Estado de reparación: ~o~60%"))
 Draw3DText2(1153.9860839844, -781.12658691406, 57.598682403564 - 0.2, tostring("~w~Arreglando su transmisión..."))
end 
...
if insidemarkercheck == true and stage1 == false and stage2 == false and stage3 == false and stage4 == true and stage5 == false and stage6 == false then
 Draw3DText(1153.9860839844, -781.12658691406, 57.598682403564 + 0.2, tostring("~w~Todavia estamos revisando su vehiculo ~o~Vuelve mas tarde"))
 Draw3DText2(1153.9860839844, -781.12658691406, 57.598682403564, tostring("~w~Estado de reparación: ~g~85%"))
 Draw3DText2(1153.9860839844, -781.12658691406, 57.598682403564 - 0.2, tostring("~w~Cambiando el aceite de su vehículo..."))
end 
...
if insidemarkercheck == true and stage1 == false and stage2 == false and stage3 == false and stage4 == false and stage5 == true and stage6 == false then
 Draw3DText(1153.9860839844, -781.12658691406, 57.598682403564 + 0.2, tostring("~w~Todavia estamos revisando su vehiculo ~o~Vuelve mas tarde"))
 Draw3DText2(1153.9860839844, -781.12658691406, 57.598682403564, tostring("~w~Estado de reparación: ~g~95%"))
 Draw3DText2(1153.9860839844, -781.12658691406, 57.598682403564 - 0.2, tostring("~w~Limpiando el interior de su vehículo..."))
end 
...
if insidemarkercheck == true and stage1 == false and stage2 == false and stage3 == false and stage4 == false and stage5 == false and stage6 == true then
 Draw3DText(1153.9860839844, -781.12658691406, 57.598682403564 + 0.2, tostring("~w~Todavia estamos revisando su vehiculo ~o~Vuelve mas tarde"))
	           Draw3DText2(1153.9860839844, -781.12658691406, 57.598682403564, tostring("~w~Estado de reparación: ~g~100%"))
	            Draw3DText2(1153.9860839844, -781.12658691406, 57.598682403564 - 0.2, tostring("¡~w~Todo está reparado, puede llevarselo!"))
end 
...
if locked == true then
Draw3DText2(plyPos.x, plyPos.y, plyPos.z + 0.2, tostring('~w~El vehiculo ha sido ~r~bloqueado'))
end

if unlocked == true then
Draw3DText2(plyPos.x, plyPos.y, plyPos.z + 0.2, tostring('~w~El vehiculo ha sido ~g~desbloqueado'))
end
...
Draw3DText2(plyPos.x, plyPos.y, plyPos.z + 0.2, tostring('~w~Las reparaciones comenzarán en un momento...'))

end

if paynotification == true then

Draw3DText2(plyPos.x, plyPos.y, plyPos.z + 0.2, tostring('~w~Pagando ~w~la reparación...'))
end

if stage6 == true then
Draw3DText(plyPos.x, plyPos.y, plyPos.z + 0.2, tostring("~w~Vehiculo esta ~g~listo ~w~para recoger"))
Draw3DText2(plyPos.x, plyPos.y, plyPos.z + 0.1, tostring("~w~Presione ~r~E~w~ bloquear tu vehiculo en el taller"))
end

if stage7 == true then
Draw3DText(plyPos.x, plyPos.y, plyPos.z, tostring("~r~Este es un mensaje de prueba de la etapa 7."))
end
		Citizen.Wait(0)
	end
end)
...
--	TriggerEvent('chatMessage', 'Bilvasken', {255, 0, 0}, "Du har ikke penge nok, du mangler ^1kr" .. moneyleft .. "") -- danish
	TriggerEvent('chatMessage', 'CivRepair', {255, 0, 0}, "No tienes suficiente dinero te faltan ^1€" .. moneyleft .. "") 
	DrawSpecialText(msg, 5000)
	Wait(5000)
end)
    --[[ 
...
--	TriggerEvent('chatMessage', 'Bilvasken', {255, 0, 0}, "Du har ikke penge nok, du mangler ^1kr" .. moneyleft .. "") -- danish
	TriggerEvent('chatMessage', 'CivRepair', {255, 0, 0}, "No tienes suficiente dinero para ^3Premium^0 te faltan ^1€" .. moneyleft .. "") 
	DrawSpecialText(msg, 5000)
	Wait(5000)
end)
...
function AutoRepair() -- Credits qalle for assisting with this 
    ...
    local elements = {
        { label = 'Reparación Rápida <font color="lightblue">⭐Premium⭐</font><font color="red">500€</font>', value = "repair_fast" },
        { label = 'Reparación <font color="orange">💤Normal💤</font><font color="red">1000€</font>', value = "repair_slow" }
    }

    ESX.UI.Menu.Open(
        'default', GetCurrentResourceName(), 'civrepair_menu',
        {
            title    = "<font color='lightblue' font-size='15px'>🔧Estación de Reparación🔧</font>",
            align    = 'center',
            elements = elements
        },
    function(data, menu)
