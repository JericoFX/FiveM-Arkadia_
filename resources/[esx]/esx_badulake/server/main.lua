...
TriggerEvent('esx_phone:registerNumber', 'badulake', _U('badulake_customer'), true, true)
TriggerEvent('esx_society:registerSociety', 'badulake', 'Badulake', 'society_badulake', 'society_badulake', 'society_badulake', {type = 'private'})



RegisterServerEvent('esx_badulake:getStockItem')
AddEventHandler('esx_badulake:getStockItem', function(itemName, count)
...
ESX.RegisterServerCallback('esx_badulake:getStockItems', function(source, cb)
...
RegisterServerEvent('esx_badulake:putStockItems')
AddEventHandler('esx_badulake:putStockItems', function(itemName, count)
...
RegisterServerEvent('esx_badulake:getFridgeStockItem')
AddEventHandler('esx_badulake:getFridgeStockItem', function(itemName, count)

  local xPlayer = ESX.GetPlayerFromId(source)

  TriggerEvent('esx_addoninventory:getSharedInventory', 'society_badulake_fridge', function(inventory)
...
ESX.RegisterServerCallback('esx_badulake:getFridgeStockItems', function(source, cb)
...
RegisterServerEvent('esx_badulake:putFridgeStockItems')
AddEventHandler('esx_badulake:putFridgeStockItems', function(itemName, count)
...
RegisterServerEvent('esx_badulake:buyItem')
AddEventHandler('esx_badulake:buyItem', function(itemName, price, itemLabel)
    ...
    TriggerEvent('esx_addonaccount:getSharedAccount', 'society_badulake', function(account)
...
RegisterServerEvent('esx_badulake:craftingCoktails')
AddEventHandler('esx_badulake:craftingCoktails', function(itemValue)
    ...
    if _itemValue == 'teqpaf' then
        SetTimeout(10000, function()        
            ...
            local alephQuantity     = xPlayer.getInventoryItem('limonade').count
            local bethQuantity      = xPlayer.getInventoryItem('badulake').count

            if alephQuantity < 2 then
                TriggerClientEvent('esx:showNotification', _source, _U('not_enough') .. _U('limonade') .. '~w~')
            elseif bethQuantity < 2 then
                TriggerClientEvent('esx:showNotification', _source, _U('not_enough') .. _U('badulake') .. '~w~')
            else
                local chanceToMiss = math.random(100)
                if chanceToMiss <= Config.MissCraft then
                    TriggerClientEvent('esx:showNotification', _source, _U('craft_miss'))
                    xPlayer.removeInventoryItem('limonade', 2)
                    xPlayer.removeInventoryItem('badulake', 2)
                else
    ...
    if _itemValue == 'metreshooter' then
        SetTimeout(10000, function()        
            ...
            local daletQuantity     = xPlayer.getInventoryItem('badulake').count
    ...
    if _itemValue == 'jagercerbere' then
        SetTimeout(10000, function()        
            ...
            local bethQuantity      = xPlayer.getInventoryItem('vodka').count
            local gimelQuantity     = xPlayer.getInventoryItem('badulake').count
...
ESX.RegisterServerCallback('esx_badulake:getVaultWeapons', function(source, cb)
...
ESX.RegisterServerCallback('esx_badulake:addVaultWeapon', function(source, cb, weaponName)
...
ESX.RegisterServerCallback('esx_badulake:removeVaultWeapon', function(source, cb, weaponName)
...
ESX.RegisterServerCallback('esx_badulake:getPlayerInventory', function(source, cb)
