...
Config.Strings = {
	...
	EToRefuel = "Presiona E para repostar",
	JerryCanEmpty = "El bidón está vacio",
	FullTank = "El tanque esta lleno",
	PurchaseJerryCan = "Presiona E para comprar un bidón de gasolina por 100$" .. Config.JerryCanCost,
	...
	RefillJerryCan = "Presiona E para para rellenar el bidón",
...
if not Config.UseESX then
	Config.Strings.PurchaseJerryCan = "Presiona E para coger un bidón"
	Config.Strings.RefillJerryCan = "Presiona E para rellenar el bidón"
end
