...
Config.WeedPrice = 75	-- sell price for single, not pooch (black money)
Config.MethPrice = 150	-- sell price for single, not pooch (black money)
Config.CokePrice = 150	-- sell price for single, not pooch (black money)
Config.OpiuPrice = 150	-- sell price for single, not pooch (black money)
