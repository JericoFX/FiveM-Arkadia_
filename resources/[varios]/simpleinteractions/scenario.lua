...
Citizen.CreateThread(function()
    ...
    WarMenu.CreateMenu('list', "RefugioGamerRP 2.0")
    WarMenu.SetSubTitle('list', 'RefugioGamerRP 2.0')
    ...
    WarMenu.CreateSubMenu('Instrucciones de uso', 'list', 'Instrucciones de uso')
    ...
    while true do
        ...
        if WarMenu.IsMenuOpened('list') then
            ...
            if WarMenu.MenuButton('Instrucciones de uso', 'Instrucciones de uso') then
            end
        ...
        elseif WarMenu.IsMenuOpened('misc') then
            ...
            WarMenu.Display()
        elseif WarMenu.IsMenuOpened('Instrucciones de uso') then

            if WarMenu.Button('RefugioGamerRP 2.0') then
                TriggerEvent("chatMessage", "RefugioGamerRP 2.0", {255, 0, 0}, "Para realizar una acción constantemente pulsa en loop, para parar la animacion pulsa en stop")
            elseif WarMenu.Button('Carapan pulsa arriba') then
            end
