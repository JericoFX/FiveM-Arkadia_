...
Citizen.CreateThread(function()
	while true do
		...
		if isActiveW == true and soyyo == false then
			drawTxt("ALGUIEN HA ACTIVADO SU LOCALIZADOR",4, 1, 0.5, 0.835, 0.85,51,255,51,255)
		end
		if isWhile == true then
			drawTxt("LOCALIZADOR ACTIVADO",4, 1, 0.5, 0.835, 0.85,51,255,51,255)
		end
		if IsControlJustPressed(1,29) then
			envaviso(x,y,z)
		end
		if isActive == true then
			drawTxt("UBICACIÓN ENVIADA",4, 1, 0.5, 0.835, 0.85,51,255,255,255)
		end
	end
end)
