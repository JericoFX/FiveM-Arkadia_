...
function showWonNotification(amount)
  ESX.ShowNotification("~o~Boleto loteria~n~~g~Has ganado!~n~~s~Felicidades, ganaste ~g~$" .. amount .. "~s~!")
end
...
function showLostNotification()
  ESX.ShowNotification("~o~Boleto loteria~n~~r~Has perdido!~n~~s~Mas suerte la proxima vez!")
end
