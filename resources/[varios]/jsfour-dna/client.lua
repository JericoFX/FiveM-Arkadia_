...
local dna 				= {}
local weapons = {
	[-1569615261] = {name = 'WEAPON_UNARMED', hash = 2725352035, text = 'Puños'},
	[-1716189206] = {name = 'WEAPON_KNIFE', hash = 2578778090, text = 'Cuchillo'},
	[1737195953]  = {name = 'WEAPON_NIGHTSTICK', hash = 1737195953, text = 'Porra de policía'},
	[2508868239]  = {name = 'WEAPON_BAT', hash = 2508868239, text = 'Bate'},
	[1317494643]  = {name = 'WEAPON_HAMMER', hash = 1317494643, text = 'Martillo'},
	[1141786504]  = {name = 'WEAPON_GOLFCLUB', hash =1141786504, text = 'Palo de Golf'},
	[2227010557]  = {name = 'WEAPON_CROWBAR', hash =2227010557, text = 'Palanca'},
	[2460120199]  = {name = 'WEAPON_DAGGER', hash =2460120199, text = 'Daga'},
	[3638508604]  = {name = 'WEAPON_KNUCKLE', hash =3638508604, text = 'Puño americano'},
	[4191993645]  = {name = 'WEAPON_HATCHET', hash =4191993645, text = 'Hacha'},
	[3713923289]  = {name = 'WEAPON_MACHETE', hash =3713923289, text = 'Machete'},
	[3756226112]  = {name = 'WEAPON_SWITCHBLADE', hash =3756226112, text = 'Navaja'},
	[3441901897]  = {name = 'WEAPON_BATTLEAXE', hash =3441901897, text = 'Hacha de batalla'},
	[2484171525]  = {name = 'WEAPON_POOLCUE', hash =2484171525, text = 'Taco de billar'},
	[419712736]   = {name = 'WEAPON_WRENCH', hash =419712736, text = 'Llave inglesa'}
}
	...
	if dna.p == nil then
		...
		if IsPedFatallyInjured(ped) then
			...
			if weapon ~= nil then
				...
				ESX.ShowNotification('Obtenga el ADN del cadáver...')
			else
				ESX.ShowNotification("No se pudo encontrar ningún ADN...")
			end
		else
			dna = {k = nil, d = nil, w = nil, p = GetPlayerServerId(player)}
			ESX.ShowNotification('Obtuvo el ADN de la persona...')
		end
	else
		ESX.ShowNotification('Ya tienes una muestra de ADN, por favor cárgala...')
	end
end)
