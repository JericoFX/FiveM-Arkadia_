...
AddEventHandler('textsent', function(tPID, names2)
	TriggerEvent('chatMessage', "", {205, 205, 0}, " Mensaje enviado a:^0 " .. names2 .."  ".."^0  - " .. tPID)
end)

RegisterNetEvent("textmsg")
AddEventHandler('textmsg', function(source, textmsg, names2, names3 )
	TriggerEvent('chatMessage', "", {205, 205, 0}, "  [ADMIN] [" .. source .."] ".. names3 .."^0: " .. textmsg)
end)

RegisterNetEvent("textmsgs")
AddEventHandler('textmsgs', function(source, textmsg, names2, names3 )
	TriggerEvent('chatMessage', "", {255, 0, 0}, " [PRIVADO] [" .. source .."] ".. names3 .."^0: " .. textmsg)
end)
