...
AddEventHandler('esx_mugging:giveMoney', function()
    ...
    TriggerClientEvent("esx:showNotification", source, ("Robaste $"):format(amount))
end)
...
AddEventHandler('esx_mugging:muggingAlert', function(street1, street2, sex, coords)
    if Config.GCPhone  then
        TriggerClientEvent("muggingNotify", -1, "Avisasion de robo por "..sex.." cerca de "..street1.." y "..street2, coords)
    else
	    TriggerClientEvent("muggingNotify", -1, "Avisasion de robo por "..sex.." cerca de "..street1.." y "..street2, coords)
    end
end)
...
AddEventHandler('esx_mugging:muggingAlertS1', function(street1, sex, coords)
    if Config.GCPhone  then
        TriggerClientEvent("muggingNotify", -1, "Avisasion de robo por  "..sex.." cerca de "..street1, coords)
    else
	    TriggerClientEvent("muggingNotify", -1, "Avisasion de robo por  "..sex.." cerca de "..street1, coords)
    end
end)
...
AddEventHandler('esx_mugging:muggingAlertS2', function(street1, sex, coords)
    if Config.GCPhone then
        TriggerClientEvent("muggingNotify", -1, "Avisasion de asesinato por  "..sex.." cerca de "..street1, coords)
    else
        TriggerClientEvent("muggingNotify", -1, "Avisasion de asesinato por  "..sex.." cerca de "..street1, coords)
    end
end)
