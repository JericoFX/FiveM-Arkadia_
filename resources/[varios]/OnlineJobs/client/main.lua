...
Citizen.CreateThread(function()
	...
	SendNUIMessage({
		...
		maxPlayers = GetConvarInt('sv_maxclients', 95),
...
function UpdatePlayerTable(connectedPlayers)
	...
	local ems, badulake, police, taxi, mechanic, players = 0, 0, 0, 0, 0, 0, 0 -- Añadir aqui los trabajos
 ...
 -- Apara añadir mas trabajos al contador copie uno y pegalo, cambia el nombre del trabajo
	...
	SendNUIMessage({
		...
		jobs   = {ems = ems, police = police, taxi = taxi, mechanic = mechanic, badulake = badulake, player_count = players} -- Esta linea es para que se actualice el contador de trabajos
	})
end
