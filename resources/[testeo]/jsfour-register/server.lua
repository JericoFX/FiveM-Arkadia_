...
AddEventHandler('es:playerLoaded', function( source )
  getIdentity(source, function(data)
    ...
    if data.firstname == '' or data.firstname == nil or data.firstname == 0 or data.firstname == '0' then
      ...
      print('Cargada identidad para ' .. data.firstname .. ' ' .. data.lastname)
    end
  end)
end)
...
TriggerEvent('es:addGroupCommand', 'idhelp', "user", function(source, args, user)
  ...
  TriggerClientEvent('chatMessage', source, 'IDHelp', {255, 0, 0}, "/delchar - Elimina el personaje")
end, function(source, args, user)
  TriggerClientEvent('chatMessage', source, "IDHelp", {255, 0, 0}, "Permisos insuficientes!")
end, {help = "Lista De personajes"})
