...
Config.Garages = {
	...
	["D"] = {
        ["positions"] = {
            ["menu"] = {
                ["position"] = vector3(217.63, -809.01, 30.71)
            },
            ["vehicle"] = {
                ["position"] = vector3(230.74, -799.02, 30.56), 
                ["heading"] = 160.0
            }
        },
        ["camera"] = { 
...
Config.Labels = {
    ["menu"] = "~INPUT_CONTEXT~ Presione para abrir el garaje. %s.",
    ["vehicle"] = "'%s'ı Presiona ~INPUT_CONTEXT~ para guardar vehiculo."
}
...
Config.AlignMenu = "button-left" -- this is where the menu is located [left, right, center, top-right, top-left etc.]