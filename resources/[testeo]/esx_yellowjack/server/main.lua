...
if Config.MaxInService ~= -1 then
  TriggerEvent('esx_service:activateService', 'yellowjack', Config.MaxInService)
end

TriggerEvent('esx_phone:registerNumber', 'yellowjack', _U('yellowjack_customer'), true, true)
TriggerEvent('esx_society:registerSociety', 'yellowjack', 'YellowJack', 'society_yellowjack', 'society_yellowjack', 'society_yellowjack', {type = 'private'})
...
RegisterServerEvent('esx_yellowjack:getFridgeStockItem')
AddEventHandler('esx_yellowjack:getFridgeStockItem', function(itemName, count)
...
ESX.RegisterServerCallback('esx_yellowjack:getFridgeStockItems', function(source, cb)
...
RegisterServerEvent('esx_yellowjack:putFridgeStockItems')
AddEventHandler('esx_yellowjack:putFridgeStockItems', function(itemName, count)
...
RegisterServerEvent('esx_yellowjack:buyItem')
AddEventHandler('esx_yellowjack:buyItem', function(itemName, price, itemLabel)
...
RegisterServerEvent('esx_yellowjack:craftingCoktails')
AddEventHandler('esx_yellowjack:craftingCoktails', function(itemValue)
    ...
    if _itemValue == 'teqpaf' then
        SetTimeout(10000, function()        
            ...
            local alephQuantity     = xPlayer.getInventoryItem('limonade').count
            local bethQuantity      = xPlayer.getInventoryItem('yellowjack').count

            if alephQuantity < 2 then
                TriggerClientEvent('esx:showNotification', _source, _U('not_enough') .. _U('limonade') .. '~w~')
            elseif bethQuantity < 2 then
                TriggerClientEvent('esx:showNotification', _source, _U('not_enough') .. _U('yellowjack') .. '~w~')
            else
                local chanceToMiss = math.random(100)
                if chanceToMiss <= Config.MissCraft then
                    TriggerClientEvent('esx:showNotification', _source, _U('craft_miss'))
                    xPlayer.removeInventoryItem('limonade', 2)
                    xPlayer.removeInventoryItem('yellowjack', 2)
                else
    ...
    if _itemValue == 'metreshooter' then
        SetTimeout(10000, function()        
            ...
            local daletQuantity     = xPlayer.getInventoryItem('yellowjack').count
    ...
    if _itemValue == 'jagercerbere' then
        SetTimeout(10000, function()        
            ...
            local bethQuantity      = xPlayer.getInventoryItem('vodka').count
            local gimelQuantity     = xPlayer.getInventoryItem('yellowjack').count
...
ESX.RegisterServerCallback('esx_yellowjack:getVaultWeapons', function(source, cb)
...
ESX.RegisterServerCallback('esx_yellowjack:addVaultWeapon', function(source, cb, weaponName)
...
ESX.RegisterServerCallback('esx_yellowjack:removeVaultWeapon', function(source, cb, weaponName)
