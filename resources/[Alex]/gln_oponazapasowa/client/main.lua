...
AddEventHandler('gln_oponazapasowa:uzyj', function()
	ESX.ShowHelpNotification('~r~Ir a la rueda destruida!')
	animacja()
end)
		...
		if DoesEntityExist(vehicle) then
			...
			TriggerServerEvent('gln_oponazapasowa:usunOpone')
				...
				Citizen.CreateThread(function()
					...
					TriggerEvent("pNotify:SendNotification", {text = "Usted está en el proceso de reemplazar el neumático!", type = "info", timeout = 5000, layout = "centerLeft"})
					...
					if CurrentAction ~= nil then
						...
						if closestTire ~= nil then
							...
							TriggerEvent("pNotify:SendNotification", {text = "Ya has terminado de reemplazar el neumático!", type = "success", timeout = 2000, layout = "centerLeft"})
						end
					end
